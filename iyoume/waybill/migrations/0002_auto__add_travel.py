...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'waybill.travel': {
            ...
            'from_point': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'travel_from_point'", 'to': u"orm['waybill.GeoPoint']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'meeting_point': ('django.db.models.fields.TextField', [], {}),
            'passangers': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'symmetrical': 'False'}),
            'to_point': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'travel_to_point'", 'to': u"orm['waybill.GeoPoint']"})
        },
        u'waybill.waybill': {
